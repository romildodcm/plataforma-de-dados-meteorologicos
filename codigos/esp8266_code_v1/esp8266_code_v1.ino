/*******************************************************************************
 * STATUS: Ok on ESP8266.
 * 
 * CSV Description
 * 
 * 20201014222901,22.05,98612.67,21.80,80.23,N,9.72,1.75,1
 * date_and_time,bmp_temperature,bmp_pressure,sht_temperature,sht_humidity,wind_direction,anemometer(km/h),pluviometer,sd_status
 * 
 ...
 * Others libraries you can add via Arduino IDE Library Manager
****************/
// LIBRARIES
...
const int mqttPort = 12345;                   // Add your MQTT Port
const char *mqttTopicSub = "ws/esp";          // Topic, if you change this, need to change on Python Script of Raspberry
